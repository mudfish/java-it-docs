...
module.exports = {
  ...
  themeConfig: {
    ...
    repo: 'mudfish/java-it-docs', // 导航栏右侧生成Github链接
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, href: String}
      name: 'laoxu', // 必需
      href: 'https://github.com/mudfish' // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:indexman@126.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/mudfish'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
          link: 'https://music.163.com/#/playlist?id=13478485'
        }
      ]
    },
    footer: { // 页脚信息
